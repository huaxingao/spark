...
#' @param initMode the initialization algorithm. This can be either "random" to use a random vector
#'                 as vertex properties, or "degree" to use a normalized sum of similarities with
#'                 other vertices. Default: "random".
...
#'         The schema of it will be: \code{id: Numeric}, \code{cluster: Integer}
